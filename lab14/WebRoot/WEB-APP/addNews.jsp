            ...
            <div class="row">
                ...
                <div class="col-9">
                    <form action="news-add" method="post" >
                        <h3>发布新闻：</h3><br>
                        <label for="">标题： </label><input type="text" name="news.title" ><br>
                        <label for="">类型： </label>
                        ...
                        <br>
                        <label for="">内容： </label>
                        <textarea name="news.content" cols="30" rows="10"></textarea>
                        <br>
                        <label for="">来源： </label><input type="text" name="news.wherefrom" ><br>
